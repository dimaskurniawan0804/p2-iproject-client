            ...
            <div class="hidden sm:block sm:ml-6 mr-5">
                <div class="flex space-x-4 align-middle">
                    <a @click.prevent="toHome" href="#"
                        class="text-white opacity-80 text-md uppercase hover:opacity-100 px-3 py-2">Home</a>
                    <a @click.prevent="toGallery" href="#"
                        class="text-white opacity-80 text-md uppercase hover:opacity-100 px-3 py-2">Gallery</a>
                    <a @click.prevent="toMyItinerary" href="#"
                        class="text-white opacity-80 text-md uppercase hover:opacity-100 px-3 py-2">My Itinerary</a>
                    <a v-if="flag === true" href="#"
                        class="text-white opacity-80 text-md uppercase hover:opacity-100 px-3 py-2"
                        @click.prevent="doLogout">Logout
                    </a>
                    <a v-if="flag === false" href="#"
                        class="text-white opacity-80 text-md uppercase hover:opacity-100 px-3 py-2"
